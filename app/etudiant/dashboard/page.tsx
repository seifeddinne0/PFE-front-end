    ...
    return (
        <div className="animate-in fade-in space-y-8">
            ...
            <div className="relative overflow-hidden rounded-2xl bg-[#042954] text-white p-8 shadow-lg">
                ...
                <div className="absolute bottom-[-20%] left-[-5%] w-[30%] h-[100%] rounded-full bg-[#4caf50]/20 blur-[60px]" />
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-6">
                    ...
                    <div className="space-y-4">
                        <div className="flex items-start gap-4 p-4 rounded-lg hover:bg-gray-50 transition-colors border border-transparent hover:border-gray-100">
                            <div className="w-10 h-10 rounded-full bg-[#fff3e0] flex items-center justify-center text-[#ffa000] flex-shrink-0 mt-1">
                                <AlertTriangle size={18} />
                            </div>
                            <div>
                                <p className="text-sm font-medium text-[#333333]">Nouvelle absence signalée en Mathématiques.</p>
                        ...
                        <div className="flex items-start gap-4 p-4 rounded-lg hover:bg-gray-50 transition-colors border border-transparent hover:border-gray-100">
                            ...
                            <div>
                                <p className="text-sm font-medium text-[#333333]">Rappel : Remise du TP d&apos;informatique ce soir.</p>
                ...
                <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-6">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <Link href="/etudiant/absences" className="p-4 border rounded-lg hover:border-[#03a9f4] hover:bg-blue-50 transition-colors flex flex-col items-center justify-center gap-2 text-[#333333] group">
                            ...
                            <span className="font-semibold text-sm mt-2">Mes Absences</span>
                        </Link>

                        <Link href="/etudiant/cours" className="p-4 border rounded-lg hover:border-[#4caf50] hover:bg-green-50 transition-colors flex flex-col items-center justify-center gap-2 text-[#333333] group">
                            <div className="p-3 bg-green-100 rounded-full group-hover:bg-[#4caf50] transition-colors">
                                <BookOpen className="text-[#4caf50] group-hover:text-white" size={24} />
                            </div>
                            <span className="font-semibold text-sm mt-2">Voir mes cours</span>
                        </Link>
                    </div>
                </div>
            </div>
