        ...
        <div className="space-y-8">
            ...
            <div className="bg-white dark:bg-slate-800 rounded-xl border border-gray-100 dark:border-slate-700/50 shadow-sm overflow-hidden">
                ...
                <div className="p-6 border-b border-gray-100 dark:border-slate-700/50 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                    <h2 className="text-xl font-bold text-[#042954] dark:text-white">Notes & Résultats</h2>
                    ...
                    <table className="w-full text-left border-collapse">
                        ...
                        <tbody>
                            {isLoading ? (
                                ...
                                <tr>
                                    <td colSpan={8} className="p-8 text-center text-gray-500 dark:text-slate-400">Aucune note enregistrée.</td>
                                </tr>
                            ) : (
                                paginatedNotes.map((note, index) => (
                                    <tr key={note.id} className="border-b border-gray-100 dark:border-slate-700/50 hover:bg-gray-50/50 dark:hover:bg-[#151515] transition-colors dark:text-slate-400">
                                        <td className="p-4 text-center text-sm text-gray-400 dark:text-slate-500 font-medium">
                                            {(currentPage - 1) * itemsPerPage + index + 1}
                                        </td>
                                        <td className="p-4">
                                            <div className="font-bold text-[#333333] dark:text-slate-100">{note.etudiantNom} {note.etudiantPrenom}</div>
                                        </td>
                                        <td className="p-4 text-gray-500 dark:text-slate-400 text-sm">{note.matiere || "-"}</td>
                                        ...
                                        <td className="p-4 text-gray-500 dark:text-slate-400 text-sm truncate max-w-[200px]">{note.commentaire || "-"}</td>
                ...
                {!isLoading && notes.length > 0 && (
                    <div className="p-4 border-t border-gray-100 dark:border-slate-700/50 flex items-center justify-between text-sm">
                        <div className="flex items-center gap-3">
                            ...
                            <div className="flex items-center gap-2 border-l pl-3">
                                ...
                                <select
                                    ...
                                    className="border border-gray-300 dark:border-slate-600 rounded px-2 py-1 text-sm focus:outline-none focus:ring-2 focus:ring-[#ffa000]"
                                >
                                    {[5, 10, 25, 50].map(n => (
                        ...
                        <div className="flex items-center gap-1">
                            <button disabled={currentPage === 1} onClick={() => setCurrentPage(1)} className="p-1 border border-gray-300 dark:border-slate-600 rounded text-gray-500 dark:text-slate-400 hover:bg-gray-50 dark:bg-slate-800/50 disabled:opacity-50 disabled:cursor-not-allowed transition-colors" title="Première page">
                                <ChevronsLeft size={18} />
                            </button>
                            <button disabled={currentPage === 1} onClick={() => setCurrentPage(p => Math.max(1, p - 1))} className="p-1 border border-gray-300 dark:border-slate-600 rounded text-gray-500 dark:text-slate-400 hover:bg-gray-50 dark:bg-slate-800/50 disabled:opacity-50 disabled:cursor-not-allowed transition-colors" title="Page précédente">
                                <ChevronLeft size={18} />
                            </button>
                            ...
                            {Array.from({ length: totalPages }).map((_, i) => (
                                <button
                                    ...
                                    className={`w-8 h-8 rounded border transition-colors font-medium flex items-center justify-center ${currentPage === i + 1
                                        ...
                                        : 'border-gray-300 dark:border-slate-600 text-gray-500 dark:text-slate-400 hover:bg-gray-50 dark:bg-slate-800/50'
                                        }`}
                                >
                                    {i + 1}
                                </button>
                            ...
                            <button disabled={currentPage === totalPages} onClick={() => setCurrentPage(p => Math.min(totalPages, p + 1))} className="p-1 border border-gray-300 dark:border-slate-600 rounded text-gray-500 dark:text-slate-400 hover:bg-gray-50 dark:bg-slate-800/50 disabled:opacity-50 disabled:cursor-not-allowed transition-colors" title="Page suivante">
                                <ChevronRight size={18} />
                            </button>
                            <button disabled={currentPage === totalPages} onClick={() => setCurrentPage(totalPages)} className="p-1 border border-gray-300 dark:border-slate-600 rounded text-gray-500 dark:text-slate-400 hover:bg-gray-50 dark:bg-slate-800/50 disabled:opacity-50 disabled:cursor-not-allowed transition-colors" title="Dernière page">
                        ...
                        <form onSubmit={handleEditSubmit} className="p-8 space-y-6">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div className="space-y-2">
                                    <label className="text-sm font-bold text-[#333333] dark:text-slate-100">Étudiant <span className="text-red-500">*</span></label>
                                ...
                                <div className="space-y-2">
                                    <label className="text-sm font-bold text-[#333333] dark:text-slate-100">Matière <span className="text-red-500">*</span></label>
                                ...
                                <div className="space-y-2">
                                    <label className="text-sm font-bold text-[#333333] dark:text-slate-100">Note (0 - 20) <span className="text-red-500">*</span></label>
                                ...
                                <div className="space-y-2">
                                    <label className="text-sm font-bold text-[#333333] dark:text-slate-100">Type de Note <span className="text-red-500">*</span></label>
                                ...
                                <div className="space-y-2">
                                    <label className="text-sm font-bold text-[#333333] dark:text-slate-100">Semestre <span className="text-red-500">*</span></label>
                            ...
                            <div className="space-y-2">
                                <label className="text-sm font-bold text-[#333333] dark:text-slate-100">Commentaire</label>
                            ...
                            <div className="pt-6 border-t border-gray-100 dark:border-slate-700 flex items-center justify-end gap-4">
                                <button type="button" onClick={() => setEditingNote(null)} className="px-6 py-3 font-semibold text-gray-500 dark:text-slate-400 hover:bg-gray-50 dark:bg-slate-800/50 rounded-lg transition-colors text-sm">
                                    Annuler
                                </button>
                                <button
                                    type="submit"
