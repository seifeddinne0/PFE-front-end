    ...
    return (
        <div className="max-w-4xl mx-auto">
            ...
            <div className="flex items-center gap-4 mb-8">
                ...
                <div>
                    <h1 className="text-[#042954] dark:text-whitexl font-bold text-[#042954] dark:text-white tracking-tight">Ajouter un enseignant</h1>
                    <p className="text-sm text-gray-500 dark:text-slate-400">Renseignez les informations du nouvel enseignant</p>
                </div>
            </div>
            ...
            <div className="bg-white dark:bg-slate-800 rounded-xl border border-gray-100 dark:border-slate-700 shadow-sm p-8">
                <form onSubmit={handleSubmit} className="space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        {/* Mot de passe */}
                        <div className="space-y-2">
                            <label htmlFor="password" className="text-sm font-bold text-[#333333] dark:text-slate-100">Mot de passe <span className="text-red-500">*</span></label>
