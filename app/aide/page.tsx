                    ...
                    <div className="bg-white dark:bg-slate-800 rounded-xl shadow-lg overflow-hidden border border-gray-100 dark:border-slate-700">
                        ...
                        <div className="bg-[#042954] p-8 text-center text-white relative overflow-hidden">
                            ...
                            <div className="relative z-10 flex flex-col items-center">
                                <div className="bg-white/10 dark:bg-slate-800/50 p-4 rounded-full mb-4 ring-2 ring-white/20">
                            ...
                            <form className="space-y-6">
                                <div className="grid md:grid-cols-2 gap-6">
                                    ...
                                    <div className="space-y-2">
                                        <label htmlFor="name" className="block text-sm font-semibold text-[#042954] dark:text-white">Nom Complet</label>
                                        <div className="relative">
                                            ...
                                            <input
                                                type="text"
                                                id="name"
                                                className="w-full pl-10 pr-4 py-3 bg-gray-50 dark:bg-slate-800/50 border border-gray-200 dark:border-slate-700 rounded-lg text-gray-800 dark:text-gray-200 focus:outline-none focus:ring-2 focus:ring-[#ffa000]/50 focus:border-[#ffa000] transition-all"
                                    ...
                                    {/* Email */}
                                    <div className="space-y-2">
                                        <label htmlFor="email" className="block text-sm font-semibold text-[#042954] dark:text-white">Adresse Email</label>
                                        <div className="relative">
                                            <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                ...
                                <div className="grid md:grid-cols-2 gap-6">
                                    {/* Rôle */}
                                    <div className="space-y-2">
                                        <label htmlFor="role" className="block text-sm font-semibold text-[#042954] dark:text-white">Votre Rôle</label>
                                        <div className="relative">
                                            <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                            ...
                                            <select
                                                id="role"
                                                className="w-full pl-10 pr-4 py-3 bg-gray-50 dark:bg-slate-800/50 border border-gray-200 dark:border-slate-700 rounded-lg text-gray-800 dark:text-gray-200 focus:outline-none focus:ring-2 focus:ring-[#ffa000]/50 focus:border-[#ffa000] transition-all appearance-none"
                                                required
                                                defaultValue=""
                                            >
                                    ...
                                    {/* Sujet */}
                                    <div className="space-y-2">
                                        <label htmlFor="subject" className="block text-sm font-semibold text-[#042954] dark:text-white">Sujet</label>
                                        <div className="relative">
                                            <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                ...
                                {/* Message */}
                                <div className="space-y-2">
                                    <label htmlFor="message" className="block text-sm font-semibold text-[#042954] dark:text-white">Votre Message</label>
                                    <div className="relative">
                                        <div className="absolute top-3 left-3 flex items-start pointer-events-none">
                                            <MessageSquare size={18} className="text-gray-400 dark:text-slate-500" />
                                        </div>
                                        <textarea
                                            id="message"
                                            rows={5}
                                            className="w-full pl-10 pr-4 py-3 bg-gray-50 dark:bg-slate-800/50 border border-gray-200 dark:border-slate-700 rounded-lg text-gray-800 dark:text-gray-200 focus:outline-none focus:ring-2 focus:ring-[#ffa000]/50 focus:border-[#ffa000] transition-all resize-none"
